...
export default function Upload() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-between p-24 bg">
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <Formik
            ...
            {({ isSubmitting, setFieldValue }) => (
              <Form>
                <div className="h-auto transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0">
                  <div className="card-body">
                    ...
                    <div className="form-control">
                      <button class="btn bg-neutral border-slate-600" type="submit">
                        Upload
                      </button>                
                    </div>
                  </div>
